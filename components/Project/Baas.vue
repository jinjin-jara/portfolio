    ...
    <div class="flex flex-col">
        ...
        <ProjectModalFunction>
            ...
            <li>
                ...
                <div class="text-base leading-7">사용자 선택 정보를 전역적으로 관리하고 새로고침이나 페이지 라우팅에도 상태를 유지하기 위해 Pinia를 도입하였습니다.
                    <br />
                    이를 통해 사용자가 선택한 개발 언어와 라이브러리에 맞춰 API 사용 예시 코드를 안정적으로 보여줄 수 있도록 구현하였습니다.
                </div>
            </li>
            <li>
                <p class="mb-1 font-medium">구문 강조(syntax highlighting)을 적용한 API 사용 예제 코드 컴포넌트 구현</p>
                <div class="text-base leading-7">
                    <Tag :is-skill="true" text="highlight.js" /> 라이브러리를 활용하여 API Playground의 코드 부분을 실제 에디터에서 보이는 것처럼 구문
                    강조(syntax highlighting)를 적용하였습니다.
                    <br />하지만 화면 렌더링 시 한번 호출되어 하이라이팅을 하는 함수로, 사용자가 파라미터를 변경하면 코드 하이라이팅이 풀려버리는 현상이 있었습니다.🥲
                    이 부분은 nuxt의 내장 함수인
                    <Tag :is-skill="true" text="watch" />(특정 데이터의 변화를 감지하여 자동으로 로직을 수행하는 메서드)를 사용하여 input data에 watch를
                    걸어 즉각적으로
                    코드 하이라이팅을 적용하여 이 점을 해결할 수 있었습니다.
                </div>
            </li>
            ...
            <li>
                ...
                <div class="text-base">
                    ...
                    또한,
                    <Tag :is-skill="true" text="ContentQuery" />를 활용하여 API 검색 기능(페이지 탐색)을 보다 쉽게 구현할 수 있었습니다.
                </div>
            </li>
            <div class="flex flex-col gap-1 items-center">
