import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineComponent, defineAsyncComponent, h, computed, unref, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, mergeProps, withCtx, createVNode, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as defu, p as sanitizeStatusCode, q as getContext, r as createHooks, f as createError$1, v as klona, x as defuFn, y as toRouteMatcher, z as createRouter$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-AJlt1ro7.mjs')
  }
];
...
const auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, _from) => {
  useNuxtApp();
});
...
const errorlogs_buOeOtGkl1 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  page: defineAsyncComponent(() => import('./page-D8bwmJhd.mjs').then((m) => m.default || m))
};
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Html, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Body, { class: "antialiased text-gray-800 bg-white font-normal text-base lg:text-lg" }, {
            ...
            return [
              createVNode(_component_Body, { class: "antialiased text-gray-800 bg-white font-normal text-base lg:text-lg" }, {
                default: withCtx(() => [
                  createVNode(_component_NuxtLayout, null, {
                    default: withCtx(() => [
                      createVNode(_component_NuxtLoadingIndicator, {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-PZSmd3ul.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BTlW7ye3.mjs'));
...
export { navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, useHead as d, entry$1 as default, useRoute as e, nuxtLinkDefaults as n, resolveRouteObject as r, useRouter as u };
